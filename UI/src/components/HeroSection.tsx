      ...
      <div className="flex flex-col items-center w-full max-w-[900px] text-center">
        ...
        <div className="w-full max-w-[620px] h-[58px] flex bg-white border-2 border-black rounded-none overflow-hidden">
          ...
          <input
            ...
            className="flex-1 border-none outline-none px-5 text-lg text-black placeholder:text-gray-300 font-sans"
          />

          <button className="w-[210px] bg-[#1F1F1F] hover:bg-[#333] text-white font-sans font-bold text-base flex flex-col items-center justify-center leading-tight cursor-pointer transition-colors duration-200 shrink-0">
